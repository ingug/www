...
$(document).ready(function() {
    ...
    $('.gallery .link1 span').delay(1000).animate({top:500, opacity:1},'slow');
    ...
    //   }
      ...
      $('.mbutton').css('background','#ddd'); //버튼불다꺼!!
   ...
   $('.mbutton').click(function(event){  //각각의 버튼 클릭시
      ...
      //   $('.btn'+i).css('width','16');
		  // }
      $('.mbutton').css('background','#ddd'); //버튼 모두불꺼
  ...
  $('.ps').click(function(){ 
    ...
    $('.main .btn').click(function(){
      ...
      if($(this).is('.btnRight')){ // 오른쪽 버튼 클릭
          ...
          if(cnt==1)cnt=imageCount+1;   // 1->6 최초 왼쪽버튼 클릭시 이지미 생성
    ...
    $('.mbutton').css('width','16');
    $('.btn'+cnt).css('background','#ddd');//자신 버튼만 불켜 
    $('.btn'+cnt).css('width','30');
